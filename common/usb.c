...
int get_usb_controller_count(void);
/***********************************************************************
 * wait_ms
 */
...
int usb_init(void)
{
	...
	for (i = 0; i < get_usb_controller_count(); i++) {
		/* init low_level USB */
		printf("USB%d:   ", i);
...
int get_usb_controller_count(void)
{
	if (_HI3798M_V100_A == get_chipid() || _HI3798M_V100 == get_chipid()
		|| _HI3796M_V100 == get_chipid() || _HIFONE_B02 == get_chipid()) {
		return 2;
	}
	return 1;
}
