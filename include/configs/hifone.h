...
#ifndef __CONFIG_HIFONE_H__
#define __CONFIG_HIFONE_H__
#define CONFIG_ARCH_HIFONE
...
#include "hifone_config.h"

#if CFG_HIFONE_FPGA
#  define CONFIG_HIFONE_FPGA
#else
#  undef CONFIG_HIFONE_FPGA
#endif

#ifdef CONFIG_HIFONE_FPGA
#define CONFIG_HIFONE_SUPPORT_NOT_ROMBOOT 1
#endif
/*-----------------------------------------------------------------------
...
#  define CONFIG_NAND_FLASH_HISFC400           1
#else
...
#  define CONFIG_HISFC400_REG_BASE_ADDRESS      REG_BASE_SPI_NAND
#  define CONFIG_HISFC400_BUFFER_BASE_ADDRESS   MEM_BASE_SPI_NAND
#  define CONFIG_HISFC400_PERIPHERY_REGBASE     REG_BASE_CRG
#  define CONFIG_HISFC400_MAX_NAND_DEVICE       1
#  define CONFIG_HISFC400_MAX_CHIP              1
#  define CONFIG_HISFC400_HARDWARE_PAGESIZE_ECC
#  ifndef CONFIG_GENERIC_NAND
#    define CONFIG_GENERIC_NAND
#  endif /* CONFIG_GENERIC_NAND */
#endif /* CONFIG_NAND_FLASH_HISFC400 */
...
#ifdef CONFIG_NAND_FLASH_HISFC400
#  define CONFIG_SYS_NAND_BASE                 REG_BASE_SPI_NAND
#else
...
#define CONFIG_PRODUCTNAME            "hifone"
...
#  define CONFIG_NET_HISFV300_HIFONE          1
...
#  define CONFIG_DDR_TRAINING_HIFONE
