 ...
 * Configuation settings for the 3751X board.
 *
...
#ifndef __CONFIG_S5_H__
#define __CONFIG_S5_H__
#define CONFIG_ARCH_S5

/* Arm configuration*/
#define CONFIG_L2_OFF

#ifndef CONFIG_SDKVERSION
#  define CONFIG_SDKVERSION               "0.1.0.1 - Hi3798Cv100"
#endif
/*-----------------------------------------------------------------------
...
#if CFG_S5_FPGA
#  define CONFIG_S5_FPGA
#else
#  undef CONFIG_S5_FPGA
#endif
/*-----------------------------------------------------------------------
