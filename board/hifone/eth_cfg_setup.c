...
static int hifone_phyinf[] = {/* array index is the hw config */
	[0] = ETH_PHY_MII,
	[1] = ETH_PHY_RGMII,
	[3] = ETH_PHY_UNKNOWN,
	[4] = ETH_PHY_RMII,
...
static void set_hifone_eth_phyintf(void)
{
	u32 regval;
	u32 phy0intf;
	u32 phy1intf;
	...
	snprintf(eth_config.phyintf, sizeof(eth_config.phyintf), "%s,%s",
		 ethphy_intfname(hifone_phyinf[phy0intf]),
		 ethphy_intfname(hifone_phyinf[phy1intf]));
