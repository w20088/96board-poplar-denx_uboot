...
#define EMMC_CLK_100M              (0b000 << 8)
#define EMMC_CLK_50M               (0b001 << 8)
#define EMMC_CLK_25M               (0b010 << 8)
#define EMMC_CLK_200M              (0b011 << 8)
#define EMMC_CLK_150M              (0b110 << 8)
#define EMMC_CLK_300M              (0b100 << 8)
#define EMMC_CLK_337DOT5M          (0b101 << 8)
