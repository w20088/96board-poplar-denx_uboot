...
#define REG_BASE_GPIO_STB0              0xF8004000	/* used as GPIO0 in uboot in s5v100 */
#define REG_BASE_GPIO_STB1              0xF8009000	/* do not parse in uboot in s5v100 */
#define REG_BASE_GPIO1                  0xF8B21000
#define GPIO_SIZE                       (0x1000)
#define MAX_GPIO_NUMS                   (14)
